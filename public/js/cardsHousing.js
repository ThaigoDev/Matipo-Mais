 document.addEventListener('DOMContentLoaded', () => {
            const carousel = document.getElementById('carousel-housing');
            const prevBtn = document.querySelector('.prev-btn-hs');
            const nextBtn = document.querySelector('.next-btn-hs');
